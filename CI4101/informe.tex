% Template:     Informe CI-4101/Reporte LaTeX
% Versión:      1.2 (15/09/2016)
% Codificación: UTF-8
%
...
\newcommand{\nombreayudantelab}{Nombre del ayudante}

\newcommand{\nombredelcurso}{Hidráulica}
\newcommand{\codigodelcurso}{CI-4101}

\newcommand{\nombreuniversidad}{Universidad de Chile}
\newcommand{\nombrefacultad}{Facultad de Ciencias Físicas y Matemáticas}
\newcommand{\departamentouniversidad}{Departamento de Ingeniería Civil}
\newcommand{\imagendeldepartamento}{images/imagen_departamento}
	...
	\begin{flushright}
		...
		Ayudantes: 
			& \begin{tabular}[t]{@{}l@{}}
				...
				Pablo Jara M.
			\end{tabular}\\
		\multicolumn{2}{l}{Ayudante del laboratorio: \nombreayudantelab} \\
		& \\
...
\newcommand{\defaultimagefolder}{}                % Directorio de las imágenes 
...
% EJEMPLO DE DOCUMENTO
	...
	\section{Metodología}
		...
		\insertequation[\label{ecuacion}]{\vec{F} = m \vec{a}}
		
		\insertimage[\label{fig1}]{images/montaje.png}{width=15cm}{Ejemplo de Figura}
	...
	\section{Resultados}
		...
		\begin{figure}[H]
			\begin{center}
				\begin{subfigure}{0.9\textwidth}
					\includegraphics[width=8cm]{images/figure2.pdf}
					\includegraphics[width=8cm]{images/figure3.pdf}
				\end{subfigure}
			\end{center}
		\caption{Ejemplo de subfiguras} \label{R1}
		\end{figure}
		...
		\begin{table}[H]
			...
			\begin{tabular}{cccc}
				\toprule
				Experiencia  & $h_c$ (cm) & $l_c$ (cm) & $\rho_c$ (kg/m$^3$) \\
				\midrule
				1 & 20,0 & 14,7 & 1030 \\
				2 & 20,0 & 14,7 & 1020 \\
				3 & 20,0 & 14,7 & 1010 \\
	...
	\section{Análisis y conclusiones}
		...
		Así se cita una referencia: \cite{123}. Así se referencian tablas, figuras y ecuaciones:
	
		\begin{itemize}
			\item Tabla \ref{tab}
			\item Figura \ref{R1}
			\item ecuación (\ref{ecuacion})
		\end{itemize}
	...
	\begin{thebibliography}{99}
		...
		\bibitem{123} 
			\hbadness=10000 García, Marcelo H
			\textit{Hidrodinámica ambiental}.
			Universidad Nac. del Litoral, 1996.
			
		\bibitem{kundu2008fluid}
			\hbadness=10000 Kundu, Pijush K and Cohen, Ira M. 
			\textit{Fluid Mechanics 4th}. 
